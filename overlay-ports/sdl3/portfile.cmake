...
# Upstream vcpkg hardcodes SDL_WAYLAND_LIBDECOR=OFF, which leaves SDL3 with only
# xdg-decoration (server-side decorations) on Wayland. Compositors without SSD
# support (GNOME, Weston) then show the window with no decorations at all.
# This overlay adds an opt-in "libdecor" feature that re-enables it; SDL finds
# the system libdecor via pkg-config, like it already does for wayland/xkbcommon.
if ("libdecor" IN_LIST FEATURES)
    vcpkg_list(APPEND FEATURE_OPTIONS "-DSDL_WAYLAND_LIBDECOR=ON")
else()
    vcpkg_list(APPEND FEATURE_OPTIONS "-DSDL_WAYLAND_LIBDECOR=OFF")
endif()
...
if ("libdecor" IN_LIST FEATURES)
    message(WARNING "You will need to install libdecor to use feature libdecor:\nsudo apt install libdecor-0-dev\n")
endif()
