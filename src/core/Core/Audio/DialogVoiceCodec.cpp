...
constexpr std::array<std::int32_t, 89> K_STEP_TABLE{7, 8, 9, 10, 11, 12, 13, 14, 16, 17, 19,
    21, 23, 25, 28, 31, 34, 37, 41, 45, 50, 55, 60, 66, 73, 80, 88, 97, 107, 118, 130,
    143, 157, 173, 190, 209, 230, 253, 279, 307, 337, 371, 408, 449, 494, 544, 598, 658,
...
void decode_nibble(const std::uint8_t nibble,
  ...
  state.step_index = std::clamp(
      state.step_index + K_INDEX_DELTA.at(static_cast<std::size_t>(nibble)), 0, 88);
