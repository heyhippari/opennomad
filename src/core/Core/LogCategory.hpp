...
[[nodiscard]] constexpr std::string_view log_category_name(
    const LogCategory category) noexcept {
  switch (category) {
    ...
    case LogCategory::Scenario:  return "Scenario";
    case LogCategory::SCX:       return "SCX";
    case LogCategory::Script:    return "Script";
    case LogCategory::Audio:     return "Audio";
    case LogCategory::Music:     return "Music";
    case LogCategory::Interface: return "Interface";
    case LogCategory::I2D:       return "I2D";
...
[[nodiscard]] constexpr LogCategory log_category_from_name(
