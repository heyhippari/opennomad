...
std::expected<Application, std::string> Application::create(const std::string& title) {
  ...
  game_settings->ensure_choice("video.street_activity",
      {Settings::SettingChoice{.label = "Very Low", .raw_value = 0},
          Settings::SettingChoice{.label = "Low", .raw_value = 1},
          Settings::SettingChoice{.label = "Medium", .raw_value = 2},
          Settings::SettingChoice{.label = "High", .raw_value = 3},
          Settings::SettingChoice{.label = "Very High", .raw_value = 4}},
      3U);
  game_settings->ensure_choice("video.detail_level",
      {Settings::SettingChoice{.label = "Low", .raw_value = 0},
          Settings::SettingChoice{.label = "Medium", .raw_value = 1},
          Settings::SettingChoice{.label = "High", .raw_value = 2}},
      1U);
